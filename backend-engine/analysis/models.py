...
class Game(models.Model):
    ...
    white_accuracy = models.FloatField(null=True)
    black_accuracy = models.FloatField(null=True)
    ...
    white_num_best = models.IntegerField(default=0)
    white_num_excellent = models.IntegerField(default=0)
    white_num_good = models.IntegerField(default=0)
    white_num_inaccuracy = models.IntegerField(default=0)
    white_num_mistake = models.IntegerField(default=0)
    white_num_blunder = models.IntegerField(default=0)
    white_num_brilliant = models.IntegerField(default=0)
    white_num_great = models.IntegerField(default=0)

    black_num_best = models.IntegerField(default=0)
    black_num_excellent = models.IntegerField(default=0)
    black_num_good = models.IntegerField(default=0)
    black_num_inaccuracy = models.IntegerField(default=0)
    black_num_mistake = models.IntegerField(default=0)
    black_num_blunder = models.IntegerField(default=0)
    black_num_brilliant = models.IntegerField(default=0)
    black_num_great = models.IntegerField(default=0)
